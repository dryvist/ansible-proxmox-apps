...
# NOT --depth=1. The three-dot diff below needs the merge-base, and a shallow
# fetch sets a shallow boundary at the base tip even in a repo the workflow
# checked out with fetch-depth: 0 — the merge-base then falls outside it and
# the diff is wrong or fails outright.
