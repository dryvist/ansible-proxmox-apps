...
* **ci-gate:** make Jev authoritative for Molecule and e2e ([7d9b353](https://github.com/dryvist/ansible-proxmox-apps/commit/7d9b3538e7e054ad836906d6d42612db5420c556))
* **ci-gate:** make Jev authoritative for Molecule and e2e ([2835055](https://github.com/dryvist/ansible-proxmox-apps/commit/2835055b0b21044f37688f06660e60f9de80b3db))
* **ci:** route the runner hosts and Molecule containers through the build caches ([390bf24](https://github.com/dryvist/ansible-proxmox-apps/commit/390bf249f36e4807db9686c3ba9e8b4f294d49bb))
* **ci:** route the runner hosts and Molecule containers through the build caches ([b829a27](https://github.com/dryvist/ansible-proxmox-apps/commit/b829a270dddb6dc330a4c3a180a9de4f3500cd45))
* **cribl_stream:** route Cribl's own internal logs and metrics to Splunk ([9be59a3](https://github.com/dryvist/ansible-proxmox-apps/commit/9be59a308686e7433951a76577f6d102cd771ae2))
* **cribl_stream:** route Cribl's own internal logs and metrics to Splunk ([5376262](https://github.com/dryvist/ansible-proxmox-apps/commit/537626276d09548b0355eaa1cbb132157f5d55f1))
* **github_runner:** build the Molecule base image once per host and hand it to every scenario ([#1987](https://github.com/dryvist/ansible-proxmox-apps/issues/1987)) ([5df1617](https://github.com/dryvist/ansible-proxmox-apps/commit/5df16177167bdb36f077a7fe709293f7f42f74b8))
* **github_runner:** dedicate review slots via a review label ([2510b6e](https://github.com/dryvist/ansible-proxmox-apps/commit/2510b6ea2d7c1a775894388aa8f2a013c2cb92e4))
* **github_runner:** dedicate review slots via a review label ([2ed9be9](https://github.com/dryvist/ansible-proxmox-apps/commit/2ed9be96a6566fea0674f30d7e162fcd214d4f6b))
* **github_runner:** run Molecule on the upstream image, drop the custom build ([#2005](https://github.com/dryvist/ansible-proxmox-apps/issues/2005)) ([a714ebe](https://github.com/dryvist/ansible-proxmox-apps/commit/a714ebed5f401c1de52c5a7e16dc07615036bf2a))
* **github-exporter:** deploy github_exporter for CI runner metrics ([fac8042](https://github.com/dryvist/ansible-proxmox-apps/commit/fac80421c6ca62d059879b17c2fda136aaeebc95))
* **github-exporter:** deploy promhippie/github_exporter for CI runner metrics ([fc3acce](https://github.com/dryvist/ansible-proxmox-apps/commit/fc3accecd3b5f0bad097913c7edee1ac5787f193))
* **github-runner-arc:** add ARC pilot role (k3s + gha-runner-scale-set) ([133dd1c](https://github.com/dryvist/ansible-proxmox-apps/commit/133dd1cbf2fafca6242d33f43bcadd127fda97da))
* **github-runner-arc:** add ARC pilot role (k3s + gha-runner-scale-set) ([d53c543](https://github.com/dryvist/ansible-proxmox-apps/commit/d53c543562f2a3164c6b011b3b7aab2192bcd1e1))
* **github-runner-arc:** enable metrics, custom runner labels, chart pin tracking ([9d0d6d6](https://github.com/dryvist/ansible-proxmox-apps/commit/9d0d6d62ad858c24562b89f90218bd0acc593950))
* **github-runner-arc:** ship k3s container logs, native kubelet rotation ([3cd581f](https://github.com/dryvist/ansible-proxmox-apps/commit/3cd581fa94d120bb60a8208d71a2c6b7d9628d73))
* **github-runner:** raise concurrency on the two active CI guests ([da277d9](https://github.com/dryvist/ansible-proxmox-apps/commit/da277d965505d88efc19c324d92705796b8a46ca))
* **grafana:** verify provisioned alert rules are loaded and evaluating ([a8297b5](https://github.com/dryvist/ansible-proxmox-apps/commit/a8297b5be5871310b669a22c4f72b7afee941dc1))
* **grafana:** verify provisioned alert rules are loaded and evaluating ([f01b3e4](https://github.com/dryvist/ansible-proxmox-apps/commit/f01b3e41a750312a65802d168dd0fb0747813e8f))
* **openbao:** add a read-only github-exporter GitHub App tier ([403fa93](https://github.com/dryvist/ansible-proxmox-apps/commit/403fa9340fcf918d28cffeeee2223820bea3fb4d))
* **openbao:** add a read-only github-exporter GitHub App tier ([6b0c3f9](https://github.com/dryvist/ansible-proxmox-apps/commit/6b0c3f929e2aff2b4fa1493e6703eba04bca0242))
* **openbao:** add open-llm's public-repo write permission set ([ff592dd](https://github.com/dryvist/ansible-proxmox-apps/commit/ff592dd0d318fb4260262292985439dce6c56d17))
* **openbao:** add read-only open-llm AppRole ([1ecc79d](https://github.com/dryvist/ansible-proxmox-apps/commit/1ecc79d1236083b7911f913e151d8ebed121f9f0))
* **openbao:** add read-only open-llm AppRole for the successor harness ([b36a8e9](https://github.com/dryvist/ansible-proxmox-apps/commit/b36a8e90af20ce8ffbe86ceac3ae73d877c2330a))
* **openbao:** generate the github-actions-oss router key under apps ([f9144be](https://github.com/dryvist/ansible-proxmox-apps/commit/f9144be3278695804468bef1011b180713438426))
* **openbao:** generate the github-actions-public router key under apps ([64bff6c](https://github.com/dryvist/ansible-proxmox-apps/commit/64bff6ce4c762ff77d7815f6149d0ac65a1d4b3f))
* **openbao:** mint a dedicated router key for Hindsight ([a4445dc](https://github.com/dryvist/ansible-proxmox-apps/commit/a4445dc71a75a126b747fcbfd250c9ebddbab31e))
* **openbao:** mint a dedicated router key for Hindsight ([abbd989](https://github.com/dryvist/ansible-proxmox-apps/commit/abbd9897096ed64bd655e5bdf4a61ac520c9ba03))
* **openbao:** mint dedicated router key for n8n ([#2011](https://github.com/dryvist/ansible-proxmox-apps/issues/2011)) ([67ed768](https://github.com/dryvist/ansible-proxmox-apps/commit/67ed76897893b86cce98e1fba1a9d63715ca3dec))
* **openbao:** promote open-llm's KV bucket, fix policy path ([4caa905](https://github.com/dryvist/ansible-proxmox-apps/commit/4caa905bd874b0559261da586c3ae4f333936a94))
* **prometheus_stack,grafana_stack:** scrape and visualize llama-swap metrics ([568ffa8](https://github.com/dryvist/ansible-proxmox-apps/commit/568ffa828b1e4fba31c8a8559ef97e5f24103146))
* **prometheus_stack,grafana_stack:** scrape and visualize llama-swap metrics ([cc64cc6](https://github.com/dryvist/ansible-proxmox-apps/commit/cc64cc65d5bc7ac194dbcc5a1a5550dc182c73a9))
* **prometheus:** add a named ARC listener scrape job placeholder ([7cdf028](https://github.com/dryvist/ansible-proxmox-apps/commit/7cdf02879e8be88b060ed18851d766528ef5c335))
* **prometheus:** assert scrape targets are up in the verify playbook ([#1977](https://github.com/dryvist/ansible-proxmox-apps/issues/1977)) ([716f6e7](https://github.com/dryvist/ansible-proxmox-apps/commit/716f6e7712862b983cb0e74e33c195a424f378ac))


### Bug Fixes

* **apt_cacher_ng:** guard the first install against a vendor-config service start ([#1982](https://github.com/dryvist/ansible-proxmox-apps/issues/1982)) ([57c00cd](https://github.com/dryvist/ansible-proxmox-apps/commit/57c00cd3ec214ed25d28423a5f1679975bb7d601))
* **apt_cacher_ng:** resolve upstream mirrors through DNS, never a hosts-file pin ([#1980](https://github.com/dryvist/ansible-proxmox-apps/issues/1980)) ([1d07a75](https://github.com/dryvist/ansible-proxmox-apps/commit/1d07a750e9df50127616993e23f0b0ab103cf6c1))
* **apt_cacher_ng:** restart the daemon when a hosts-file pin is stripped ([#1981](https://github.com/dryvist/ansible-proxmox-apps/issues/1981)) ([d7b3ccb](https://github.com/dryvist/ansible-proxmox-apps/commit/d7b3ccbc7497ce5b09d8656e51f5f0741b288c07))
* **authelia:** verify release checksum from signed manifest, drop stale pin ([33f046c](https://github.com/dryvist/ansible-proxmox-apps/commit/33f046c26c79db9bbf9cfc76e280b6778b56f52f))
* **authelia:** verify release checksum from signed manifest, drop stale pin ([36d6bc3](https://github.com/dryvist/ansible-proxmox-apps/commit/36d6bc389ebbddb61578ba39115da482022af46a))
* **budget-gate:** bracket the verify and validate playbooks with the wall-clock gate ([#1964](https://github.com/dryvist/ansible-proxmox-apps/issues/1964)) ([06a2088](https://github.com/dryvist/ansible-proxmox-apps/commit/06a20884826200775791d0df51b69a1f4684f571))
* **ci-gate:** !cancelled() - a failed jev job was skipping Molecule/e2e ([75fec76](https://github.com/dryvist/ansible-proxmox-apps/commit/75fec7649d756c561d3c786cc1a79d7904239a57))
* **ci:** cache Galaxy collections in the Molecule and inventory-contract workflows ([96dcabe](https://github.com/dryvist/ansible-proxmox-apps/commit/96dcabef27db86c53555dcad66849451b4c21dc2))
* **ci:** cache Galaxy collections in the Molecule and inventory-contract workflows ([48eb431](https://github.com/dryvist/ansible-proxmox-apps/commit/48eb431b6c8d3d499e1992a0eb94b186fbb67b2f))
* **ci:** forward the router secrets to ai-pr-care with secrets: inherit ([4e97e65](https://github.com/dryvist/ansible-proxmox-apps/commit/4e97e65edf579ef2d5c6f405990545fe6fb3d19e))
* **ci:** forward the router secrets to ai-pr-care with secrets: inherit ([0170f1b](https://github.com/dryvist/ansible-proxmox-apps/commit/0170f1b71d3bcd78648de5787d846c8ee7ae785c))
* **ci:** keep every file under the token ceiling ([40f0b57](https://github.com/dryvist/ansible-proxmox-apps/commit/40f0b57afc6b146ad06fa70e02063d04b54c73ba))
* **ci:** restore the develop gate ([6e4952f](https://github.com/dryvist/ansible-proxmox-apps/commit/6e4952fcec04e43dad609149efedb20742dbd51a))
* **ci:** restore the develop gate after the build-cache and runner-pool merges ([ebf5a4c](https://github.com/dryvist/ansible-proxmox-apps/commit/ebf5a4c63d1d935b4971b1bbc7d218ee4c8d7386))
* **ci:** run Molecule/Template Rendering on hosted runners for public repos ([#2006](https://github.com/dryvist/ansible-proxmox-apps/issues/2006)) ([4a0434f](https://github.com/dryvist/ansible-proxmox-apps/commit/4a0434f0aa25a7ad5db78e44d75e11b786fc4669))
* **ci:** run the inventory contract on hosted runners for public repos ([#2012](https://github.com/dryvist/ansible-proxmox-apps/issues/2012)) ([fec9900](https://github.com/dryvist/ansible-proxmox-apps/commit/fec990005b733c036b256c00eb82d2cdaf08c75d))
* **ci:** shared molecule inputs re-run every scenario ([#2008](https://github.com/dryvist/ansible-proxmox-apps/issues/2008)) ([afd7d96](https://github.com/dryvist/ansible-proxmox-apps/commit/afd7d963a760334a57da7254a5532559d3068bf7))
* **ci:** stop inventory changes selecting every Molecule scenario ([07c8b70](https://github.com/dryvist/ansible-proxmox-apps/commit/07c8b705f9034574f06cd0deb5d789ee7421a1cc))
* **ci:** stop inventory changes selecting every Molecule scenario ([cf56327](https://github.com/dryvist/ansible-proxmox-apps/commit/cf56327bf8752ba0973a25ea3ad2671784827f6d))
* **cribl_stream:** drop LLM-observability sinks under backpressure ([#1962](https://github.com/dryvist/ansible-proxmox-apps/issues/1962)) ([31bc6c2](https://github.com/dryvist/ansible-proxmox-apps/commit/31bc6c277f85596940299b23b70f6f7d08b3f8b2))
* **cribl_stream:** manage the admin login through the converge ([#1961](https://github.com/dryvist/ansible-proxmox-apps/issues/1961)) ([db19f26](https://github.com/dryvist/ansible-proxmox-apps/commit/db19f267293ddeb36a98ab7cf833129ae663879c))
* **cribl_stream:** pin the current GA version and enforce it on converge ([#2003](https://github.com/dryvist/ansible-proxmox-apps/issues/2003)) ([b4fe872](https://github.com/dryvist/ansible-proxmox-apps/commit/b4fe872fce6ebc740c2c6a7491196676b7eb1652))
* **cribl_stream:** size Worker Processes from the guest's declared RAM ([#1996](https://github.com/dryvist/ansible-proxmox-apps/issues/1996)) ([a04c895](https://github.com/dryvist/ansible-proxmox-apps/commit/a04c8958f262557d7f9f6b1b26e5bea90391a545))
* **cribl_stream:** strip valueless OTLP attributes with a Code function, not Eval ([#2015](https://github.com/dryvist/ansible-proxmox-apps/issues/2015)) ([341e24f](https://github.com/dryvist/ansible-proxmox-apps/commit/341e24fd78040a18127647d7d217bd0e136e5e82))
* **docker:** set journald as the daemon-wide default log driver ([1fff722](https://github.com/dryvist/ansible-proxmox-apps/commit/1fff72240ae2a372a82f3ee664467b67aed0e72e))
* **docker:** set journald as the daemon-wide default log driver ([853e5be](https://github.com/dryvist/ansible-proxmox-apps/commit/853e5be7cb3c6a7b3ad5d32a649b4ccdb91c7708))
* **e2e:** classify TCP port-check failures by fault type ([855d8fe](https://github.com/dryvist/ansible-proxmox-apps/commit/855d8fe26346ca7244e49eaa0e3a34829b34d5fa))
* **e2e:** classify TCP port-check failures by fault type ([4d07859](https://github.com/dryvist/ansible-proxmox-apps/commit/4d078598509af98cd5da726c79043ab699ca6792))
* **github_runner:** block on the first Molecule image build ([2c3f9ee](https://github.com/dryvist/ansible-proxmox-apps/commit/2c3f9eef3e466137bc80d86894f076af935ec981))
* **github_runner:** block on the first Molecule image build ([0b3d7db](https://github.com/dryvist/ansible-proxmox-apps/commit/0b3d7db78e18c78afebf44823c3026265c651390))
* **github_runner:** discover github-runner@N units via systemctl ([#1984](https://github.com/dryvist/ansible-proxmox-apps/issues/1984)) ([33a7b2b](https://github.com/dryvist/ansible-proxmox-apps/commit/33a7b2b34ab4a7013866b6900fc6bb3a1d36877f))
* **github_runner:** gate the runner play on a per-host enable flag ([acc91a1](https://github.com/dryvist/ansible-proxmox-apps/commit/acc91a17f4f40329887d7f4fde8c0836019598fe))
* **github_runner:** restore runner replica counts ([1d72b4c](https://github.com/dryvist/ansible-proxmox-apps/commit/1d72b4cfc6351c7f93fb45fc1df8b3c4b3227f30))
* **github_runner:** review slots must not carry the proxmox label ([b06f2a7](https://github.com/dryvist/ansible-proxmox-apps/commit/b06f2a75f14e2dcb8c35f452522e1c36084295d5))
* **github_runner:** review slots must not carry the proxmox label ([7f68c73](https://github.com/dryvist/ansible-proxmox-apps/commit/7f68c738937d961c3bcc84a9dbf90ba79a0b6788))
* **github_runner:** ship container stdout/stderr to the host journal ([ecce426](https://github.com/dryvist/ansible-proxmox-apps/commit/ecce42667627d6ed1805904140e8efe809a19846))
* **github_runner:** ship container stdout/stderr to the host journal ([ed7dd29](https://github.com/dryvist/ansible-proxmox-apps/commit/ed7dd2971062dd389704c590d93a1277bbbebd3b))
* **github_runner:** ship runner _diag logs to the syslog pipeline ([#1939](https://github.com/dryvist/ansible-proxmox-apps/issues/1939)) ([13b119d](https://github.com/dryvist/ansible-proxmox-apps/commit/13b119d8b82f6aa3e27fc9131082c353f5d89493))
* **github_runner:** skip the Molecule image build on 0-replica hosts, set docker daemon DNS ([#1990](https://github.com/dryvist/ansible-proxmox-apps/issues/1990)) ([e2a56e1](https://github.com/dryvist/ansible-proxmox-apps/commit/e2a56e1f92eab14da77a7a48879bd11bcbd9777f))
* **github_runner:** surface the Molecule image build's own journal on failure ([a206c46](https://github.com/dryvist/ansible-proxmox-apps/commit/a206c46a4c7373b24282148a4a422f9bd92f3190))
* **github_runner:** un-drain docker-host-540 runner pool ([7cdfa8d](https://github.com/dryvist/ansible-proxmox-apps/commit/7cdfa8dd5f269c3517a3f9e0efc1aba4639f8d64))
* **github_runner:** update host_vars ([#1992](https://github.com/dryvist/ansible-proxmox-apps/issues/1992)) ([e359b6b](https://github.com/dryvist/ansible-proxmox-apps/commit/e359b6bfd6ec21f4541f65eccbbd7b497f43cf41))
* **github-runner:** stop runner replicas on the execution-plane host ([2f68df1](https://github.com/dryvist/ansible-proxmox-apps/commit/2f68df1a9ecf52f6e2889ab5253f64840f68175a))
* **github-runner:** support tearing down a runner pool via replicas=0 ([fd29e5a](https://github.com/dryvist/ansible-proxmox-apps/commit/fd29e5a420e0cec2cf5dcc97585c213d14a1030a))
* **github-runner:** treat the per-container memory limit as a cap ([e1dbf12](https://github.com/dryvist/ansible-proxmox-apps/commit/e1dbf12f6ace1f79a64d6809beadcacf00fae3b3))
* **grafana_stack:** mount provisioning/alerting into the container ([fcb6a23](https://github.com/dryvist/ansible-proxmox-apps/commit/fcb6a23937d7d09620f6072619061f6f66cebdc6))
* **grafana_stack:** mount provisioning/alerting into the container ([e29d16d](https://github.com/dryvist/ansible-proxmox-apps/commit/e29d16db7e2e608863a9de9107950ce3a4ad8269))
* **grafana:** handle whole-second lastEvaluation timestamps ([9f5523f](https://github.com/dryvist/ansible-proxmox-apps/commit/9f5523fe57997e194259379d15778439c8d08a37))
* **grafana:** handle whole-second lastEvaluation timestamps in rule freshness check ([8341c37](https://github.com/dryvist/ansible-proxmox-apps/commit/8341c377579c08507a16ff828a8e8cf08673e312))
* **grafana:** repair context-bloat groupby and add harness token split ([a031c24](https://github.com/dryvist/ansible-proxmox-apps/commit/a031c242b4884a267fbd7f48664d044d91bf1fe5))
* **grafana:** repair context-bloat groupby and add harness token split ([0100d81](https://github.com/dryvist/ansible-proxmox-apps/commit/0100d81a8fd794ce41a5875070d53a0a81aeac81))
* **inventory:** add missing llm_vllm_group syslog route ([c94e498](https://github.com/dryvist/ansible-proxmox-apps/commit/c94e49890f0623329dd08ff15033061c3d9b332a))
* **inventory:** define github_exporter_web_address where prometheus_group can see it ([01b9f32](https://github.com/dryvist/ansible-proxmox-apps/commit/01b9f32e78be8548741968545c74b5771e46da6c))
* **inventory:** define github_exporter_web_address where prometheus_group can see it ([75d09cf](https://github.com/dryvist/ansible-proxmox-apps/commit/75d09cf5ab6cd8e889a1535f571653de00a55fe4))
* **inventory:** restore syslog program route for llm_vllm_group ([d430c3b](https://github.com/dryvist/ansible-proxmox-apps/commit/d430c3bf7387124285f99ddfdeeadf03ba6fc35b))
* **logging:** extend log-forwarding host selector ([6f19a41](https://github.com/dryvist/ansible-proxmox-apps/commit/6f19a412834afa465ba7e11509d1c408dd4a5977))
* **molecule:** dump the journal when a PBS service fails to start ([f46dbce](https://github.com/dryvist/ansible-proxmox-apps/commit/f46dbceb70da719bd0030b8ec05385a52b48de56))
* **molecule:** dump the journal when a PBS service fails to start ([876c1e7](https://github.com/dryvist/ansible-proxmox-apps/commit/876c1e79c0b7eb8d74e6e2f3f8faef6eee186b83))
* **molecule:** give the github_runner_arc scenario the shared prepare ([6c7fb8c](https://github.com/dryvist/ansible-proxmox-apps/commit/6c7fb8caae0069595e6e8d2fb7f64204f93774c8))
* **molecule:** keep https repositories off the apt cache ([#1983](https://github.com/dryvist/ansible-proxmox-apps/issues/1983)) ([02bf066](https://github.com/dryvist/ansible-proxmox-apps/commit/02bf066ac1ba50621bfa6823c3d2bc7d36cca28d))
* **molecule:** make the github_runner_arc scenario runnable ([0bd4df2](https://github.com/dryvist/ansible-proxmox-apps/commit/0bd4df2d9f97e12e317b94c7b9f38641b63414c7))
* **molecule:** run the github_runner_arc scenario container like the others ([97a3e38](https://github.com/dryvist/ansible-proxmox-apps/commit/97a3e38269e4612ff15a9939a053b04b3e5b42a1))
* **object_storage:** correct nested item path for the pointer-version assert ([#2024](https://github.com/dryvist/ansible-proxmox-apps/issues/2024)) ([69f7922](https://github.com/dryvist/ansible-proxmox-apps/commit/69f7922861f6c4fc799a15686be71f2f8165f565))
* **openbao:** converge-domain AppRole secret_ids no longer expire ([#1963](https://github.com/dryvist/ansible-proxmox-apps/issues/1963)) ([d168c21](https://github.com/dryvist/ansible-proxmox-apps/commit/d168c21e3a62a8546a757571cf6a6e2dc9b01aa3))
* **openbao:** pass item explicitly into nested RBAC policy template renders ([858d40f](https://github.com/dryvist/ansible-proxmox-apps/commit/858d40fe13ccac0c92dbfe0d08c9f59aa1ce018f))
* **openbao:** pass item explicitly into nested RBAC policy template renders ([fe7b46a](https://github.com/dryvist/ansible-proxmox-apps/commit/fe7b46ab80c5b4eb7e00211c581182c51217c772))
* **openbao:** reload plugin backends on a same-version binary rewrite ([#1997](https://github.com/dryvist/ansible-proxmox-apps/issues/1997)) ([199a59d](https://github.com/dryvist/ansible-proxmox-apps/commit/199a59dd12dd4396e1f26faf6d1cad0d3b8ca406))
* **openbao:** rename open-llm's promoted vikunja field to VIKUNJA_API_TOKEN ([#2021](https://github.com/dryvist/ansible-proxmox-apps/issues/2021)) ([60bdbe5](https://github.com/dryvist/ansible-proxmox-apps/commit/60bdbe5e58ec174b431ddbd3e3f96eac923a599a))
* **openbao:** split rbac-policies to clear the per-file token budget ([cbbd38e](https://github.com/dryvist/ansible-proxmox-apps/commit/cbbd38e5323981bd91082faf09cfca62699f0657))
* **openbao:** stop treating a CIDR-refused probe as a dead secret_id ([#2023](https://github.com/dryvist/ansible-proxmox-apps/issues/2023)) ([deb954e](https://github.com/dryvist/ansible-proxmox-apps/commit/deb954e91438c66cbbd01796f29e4d467d466cc3))
* **openbao:** trim app-secrets comment under the token-limit gate ([57bc4c5](https://github.com/dryvist/ansible-proxmox-apps/commit/57bc4c5bc9e4edd72bc8daabbb48157aac4b9fc4))
* **openbao:** uppercase open-llm's promoted KV field names ([4810c52](https://github.com/dryvist/ansible-proxmox-apps/commit/4810c5266f2e4559fa8b78ff5093f25834206cc7))
* **playbooks:** address the registry mirror and apt cache under the estate domain ([9e0aa6b](https://github.com/dryvist/ansible-proxmox-apps/commit/9e0aa6bbaf077771133b313a28244c493081a4c9))
* **playbooks:** drop in a systemd-resolved config for docker VMs ([0d1f6cd](https://github.com/dryvist/ansible-proxmox-apps/commit/0d1f6cdd45f8476fc6268dceffbfe0d35e76eec8))
* **playbooks:** manage the per-link resolver override via netplan ([8fc30f6](https://github.com/dryvist/ansible-proxmox-apps/commit/8fc30f67bc9df75f9afc5b69b64da2a690147af2))
* **playbooks:** render daemon.json content with a real trailing newline ([6c575a3](https://github.com/dryvist/ansible-proxmox-apps/commit/6c575a3c99af822e0a4c38eb42134a051a760984))
* **playbooks:** sort the resolver override before the cloud-init file ([e31c4d1](https://github.com/dryvist/ansible-proxmox-apps/commit/e31c4d1c5d217bcc8a572c2011d06fe3bc821b51))
* **playbooks:** split the Docker daemon play into its own site file ([e7ba84f](https://github.com/dryvist/ansible-proxmox-apps/commit/e7ba84fc018ea2b07475fc987eb8bd61f7474759))
* **playbooks:** split the Docker daemon play into its own site file ([96a887e](https://github.com/dryvist/ansible-proxmox-apps/commit/96a887e99607ef121cc909fcbe58586ce02d2cf3))
* **playbooks:** use the truthy test in the DNS servers filter chain ([da1df92](https://github.com/dryvist/ansible-proxmox-apps/commit/da1df92caee8009dcfe916f4b851db1ed4af98e9))
* prefix both if: conditions with `!cancelled() &&`. ([75fec76](https://github.com/dryvist/ansible-proxmox-apps/commit/75fec7649d756c561d3c786cc1a79d7904239a57))
* **prometheus_stack:** drop qwen3-coder-30b from the llama-swap scrape list ([3d69427](https://github.com/dryvist/ansible-proxmox-apps/commit/3d694272352604fbbb158a639e5e86fa285c10df))
* **prometheus_stack:** recreate the stack on config changes, not a hot reload ([#2022](https://github.com/dryvist/ansible-proxmox-apps/issues/2022)) ([ee460db](https://github.com/dryvist/ansible-proxmox-apps/commit/ee460dbc1e5ebcef5b9484e8665a62840c77c34d))
* **prometheus:** derive router scrape targets from the inventory group ([f4c110f](https://github.com/dryvist/ansible-proxmox-apps/commit/f4c110f6c6dc04f2a5da2c1fb70a1f51ce6044d3))
* **prometheus:** derive router scrape targets from the inventory group ([72b93aa](https://github.com/dryvist/ansible-proxmox-apps/commit/72b93aad38a52401e0857a52407daaab8dc0951f))
* **roles:** never skip the first apt update on a bare image ([f62ea86](https://github.com/dryvist/ansible-proxmox-apps/commit/f62ea8606624f5a7bdb4e47c14b50302a9bd6211))
* **roles:** never skip the first apt update on a bare image ([a019723](https://github.com/dryvist/ansible-proxmox-apps/commit/a0197236660983b116ab6d97faf523a83a3bf309))
* **site:** raise converge wall-clock cap default to 3600s ([7ee1534](https://github.com/dryvist/ansible-proxmox-apps/commit/7ee15341159343992bedf6299a5487aa69c52c7c))
* **site:** raise the converge wall-clock cap default to 3600s ([b04d1b4](https://github.com/dryvist/ansible-proxmox-apps/commit/b04d1b49289ecd3b78e6122a62e5a23842e7dbe7))
* **status_stack:** pin uptime-kuma by version var so one Renovate manager owns it ([4522365](https://github.com/dryvist/ansible-proxmox-apps/commit/452236553cafdf45f22e0c9b7c1b14f9fbf084e9))
* **status_stack:** pin uptime-kuma by version var so one Renovate manager owns it ([211b95c](https://github.com/dryvist/ansible-proxmox-apps/commit/211b95cc7f6f4ffbb54f83efc7e112c33cd7acc7))
* **syslog:** forward docker-host-540 (github_runner fleet) to the syslog pipeline ([4ab3e04](https://github.com/dryvist/ansible-proxmox-apps/commit/4ab3e04dd45085de0bdadeeb633bc06681287aaa))
* **tests:** split the plane-hosts check into its own task file ([7d2dc64](https://github.com/dryvist/ansible-proxmox-apps/commit/7d2dc64592cb6b2c8b74859e497177062bcb2fef))
* **traefik:** honor a route's own response_header_timeout ([d8e4ba8](https://github.com/dryvist/ansible-proxmox-apps/commit/d8e4ba8ba3d382f249df6daecdf5314982edf6d9))
* **traefik:** honor a route's own response_header_timeout ([82132bd](https://github.com/dryvist/ansible-proxmox-apps/commit/82132bd29f3ad51ca123ed2260cc7b68c49f288b))
* **traefik:** the openbao probe cadence comes from the ingress row ([07e27df](https://github.com/dryvist/ansible-proxmox-apps/commit/07e27df760243d62fa98f16a0ba93bfebb9b7de4))
* **traefik:** the openbao probe cadence comes from the ingress row ([a952b4e](https://github.com/dryvist/ansible-proxmox-apps/commit/a952b4e3bc76bb44d51312ad2817a53efbefa092))
* **zammad:** use a dedicated router key ([#1994](https://github.com/dryvist/ansible-proxmox-apps/issues/1994)) ([f3842fa](https://github.com/dryvist/ansible-proxmox-apps/commit/f3842fad0cb03faa8cc5e4b54302fd8a8c374348))


### Performance

* **openbao:** move remaining read loops to the controller ([4901d14](https://github.com/dryvist/ansible-proxmox-apps/commit/4901d146a7250b0d02121d20a12480977d4cedae))
* **openbao:** move remaining read loops to the controller ([f1fe231](https://github.com/dryvist/ansible-proxmox-apps/commit/f1fe231f46460946e1065cf95a6d93442f53761f))
...
* **cribl_stream:** route llm_router's ai log port as syslog ([#1874](https://github.com/dryvist/ansible-proxmox-apps/issues/1874)) ([df8f099](https://github.com/dryvist/ansible-proxmox-apps/commit/df8f09971216b7c194a99bd0a9c7c1073f3cfa72))
...
* **github_runner:** assert Docker data filesystem headroom at converge time ([#1875](https://github.com/dryvist/ansible-proxmox-apps/issues/1875)) ([989d50f](https://github.com/dryvist/ansible-proxmox-apps/commit/989d50f0cc91f102670b027cdc89d297905340c7))
...
* **baseline:** pin fuse-overlayfs only on LXC guests, keep Docker started ([#1879](https://github.com/dryvist/ansible-proxmox-apps/issues/1879)) ([f86b314](https://github.com/dryvist/ansible-proxmox-apps/commit/f86b314038d1e29b7383103103f5c76fd2475a37))
* **docker_engine:** never pin a storage driver on a virtual machine ([#1880](https://github.com/dryvist/ansible-proxmox-apps/issues/1880)) ([eb8c8ff](https://github.com/dryvist/ansible-proxmox-apps/commit/eb8c8ff3677b4d6e996d0893af2b2bb8fc35b06d))
* **nautobot:** run the drift playbook without privilege escalation ([#1873](https://github.com/dryvist/ansible-proxmox-apps/issues/1873)) ([730aad7](https://github.com/dryvist/ansible-proxmox-apps/commit/730aad759b6af7c9ce44ffcd922ec5234b8b9b08))
* **openbao_secrets:** declare apps/pve-exporter optional ([#1878](https://github.com/dryvist/ansible-proxmox-apps/issues/1878)) ([22b5ebe](https://github.com/dryvist/ansible-proxmox-apps/commit/22b5ebe8f7d4fba3e67db8f02459769c5b6ba78f))
...
* **openbao:** bind github-repo-create to the workstation class ([#1869](https://github.com/dryvist/ansible-proxmox-apps/issues/1869)) ([7043023](https://github.com/dryvist/ansible-proxmox-apps/commit/7043023a723d5de44e78904abc1892ed46c7a141))
...
* **openbao:** gate the KV-mounts init step behind reconcile mode ([#1865](https://github.com/dryvist/ansible-proxmox-apps/issues/1865)) ([1c36a72](https://github.com/dryvist/ansible-proxmox-apps/commit/1c36a7236af4655bf1a106665c681d8492b6def2))
...
* **openbao:** guard secret-age rsyslog drop-in against duplicate imfile load ([#1877](https://github.com/dryvist/ansible-proxmox-apps/issues/1877)) ([34186ab](https://github.com/dryvist/ansible-proxmox-apps/commit/34186ab3636c73064aa77d9f9dfe3bbed1d8ec81))
...
* **openbao:** tune the approle mount login lockout for shared aliases ([#1872](https://github.com/dryvist/ansible-proxmox-apps/issues/1872)) ([afc5203](https://github.com/dryvist/ansible-proxmox-apps/commit/afc520366303eac2f433c92904a3491688b93f29))
* **openbao:** unbound redemption count on the workstation GitHub AppRoles ([#1871](https://github.com/dryvist/ansible-proxmox-apps/issues/1871)) ([c39e137](https://github.com/dryvist/ansible-proxmox-apps/commit/c39e137ab97eb6f94878e969bb5da8b36e80eae3))
* **service_deadman:** reach bao_monitoring_secrets on every target host ([#1868](https://github.com/dryvist/ansible-proxmox-apps/issues/1868)) ([7f416a3](https://github.com/dryvist/ansible-proxmox-apps/commit/7f416a34140ebbed7195d960dd0329234fed722e))
